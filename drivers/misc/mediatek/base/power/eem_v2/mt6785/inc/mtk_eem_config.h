...
#define VMIN_VAL		(0x1B) /* volt domain: 0.6v*/
#define VCO_VAL			(0x18)
...
#define VMIN_VAL_B		(0x1B) /* volt domain: 0.6v*/
#define VCO_VAL_B		(0x18) /* volt domain: 0.6v*/
...
#define VMIN_VAL_GPU                    (0x1B) /* eem domain: 0.6125v*/
#define VCO_VAL_GPU                     (0x18) /* eem domain: 0.575v*/

/* different for GPU_L */
#define VMAX_VAL_GL                     (0x73)
#define VMIN_VAL_GL                     (0x1B)
